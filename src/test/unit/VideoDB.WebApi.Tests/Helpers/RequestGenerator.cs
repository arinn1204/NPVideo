    ...
    public class RequestGenerator
    {
        public static VideoRequest GetVideoRequest(string id = "tt134132")
        {
            return new AutoFaker<VideoRequest>()
                .RuleFor(r => r.Actors, r => GetStars(3))
                .RuleFor(r => r.Directors, r => GetStars(1))
                .RuleFor(r => r.Writers, r => GetStars(3))
                .RuleFor(r => r.Producers, r => GetStars(3))
        ...
        public static TvEpisodeRequest GetTvEpisodeRequest(string videoId = "tt134132", string tvepisodeId = "tt134133")
        {
            return new AutoFaker<TvEpisodeRequest>()
                ...
                .RuleFor(r => r.Title, r => string.Join(" ", r.Lorem.Words(new Random().Next(0, 10000))))
                .RuleFor(r => r.EpisodeName, r => string.Join(" ", r.Lorem.Words(new Random().Next(0, 10000))))
                .RuleFor(r => r.Plot, r => string.Join(" ", r.Lorem.Words(new Random().Next(0, 10000))))
                .RuleFor(r => r.EpisodePlot, r => string.Join(" ", r.Lorem.Words(new Random().Next(0, 10000))))
                .RuleFor(r => r.MpaaRating, r => GenerateString(r, 7))
                .RuleFor(r => r.Runtime, r => r.Finance.Amount(0, 999, 2))
        ...
        private static IEnumerable<StarRequest> GetStars(int number = 1)
        {
